...
echo "     or open this folder in Google Antigravity CLI (agy) and say:"
...
echo ""
echo "Linux: for global push-to-talk across all windows on Wayland/X11,"
echo "add your user to the input group: sudo usermod -aG input $USER"
echo "(requires logging out and logging back in)."
